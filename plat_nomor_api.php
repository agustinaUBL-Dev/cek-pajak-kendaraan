...
function get_info_motor($nomor_full){
	...
	// curl
	$ch = curl_init();
	curl_setopt($ch, CURLOPT_URL,"http://pkb.bapenda.lampungprov.go.id/pkb/");
	...
	$headers = [
		...
		'host: pkb.bapenda.lampungprov.go.id',
		'origin: http://pkb.bapenda.lampungprov.go.id',
		'referer: http://pkb.bapenda.lampungprov.go.id/pkb/',
...
function filter_data($data_mentah){
	...
	$d6 = explode(' <div id="head-ipk" class="tit-ipk"><b>pkb</b></div>', $d5[1]);
	$d7 = $d6[1];
